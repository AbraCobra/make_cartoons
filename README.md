...
"TXLib.h". Именно эта библиотека позволит вам нарисовать и оживить вашего героя.</p>  Найти ее можно по ссылке
...
[Цикл](https://github.com/AbraCobra/make_cartoons/blob/main/To_many_cactuses.cpp)
