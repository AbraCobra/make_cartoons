//========================================================================
//    Cactus  starts to smile and even to suffer.  (6)
//========================================================================
...
void Cactus_moving_Happy()
    ...
    while (t <= 70)
        ...
        Cactus_drawer ( 200, 500, 0.4, 0.4, 20 - t/2,  10 - t/10,   1,  10 - t/10,   1,  - 25 + t/2);
...
void Cactus_moving_Sad ()
    ...
    while (t <= 70)
        ...
        Cactus_drawer ( 200, 500, 0.4, 0.4, 5 + t/3, 1 + t/3, 1, 1 + t/3, 1, 20 - t);;
